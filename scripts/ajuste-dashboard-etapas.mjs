...
// Retira a barra de etapas que foi injetada anteriormente. Mantemos apenas a busca global.
source = source.replace('import NeoTopBar from "./NeoTopBar.jsx";\n', "");
source = source.replace(/\s*<NeoTopBar[\s\S]*?\/>\s*(?=<style>)/, "\n");
